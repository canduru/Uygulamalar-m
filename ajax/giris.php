                ...
                <div id="panel">
                    <div class="aktifpanel" id="icpanel">
                        ...
                        <div class="elemanlar">
                          ...
                          <div class="sunuttum"><a href="?sunuttum=1" style="text-decoration: none;color:#7B6C66">Şifremi unuttum</a></div>
                            <div><input type="submit" class="butonBasvur" value="Kayıt Ol" /> </div>
                        </div>
